...
We recommend starting with a project WIKI [https://github.com/LeatherLedger/LeatherLedger/wiki](https://github.com/LeatherLedger/LeatherLedger/wiki).

Also from the [README.md](https://github.com/LeatherLedger/LeatherLedger/blob/master/README.MD) file.

You can start with both improving documentation or solving [issues](https://github.com/LeatherLedger/LeatherLedger/issues).
...
Please send a [GitHub Pull Request](https://github.com/LeatherLedger/LeatherLedger/pull/new/master) with a clear list of what you've done (read more about [pull requests](http://help.github.com/pull-requests/)). Please follow our coding conventions (below).
